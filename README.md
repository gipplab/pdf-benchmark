...
*<img src="https://render.githubusercontent.com/render/math?math={\gamma}"> : Levenshtein ratio
*<img src="https://render.githubusercontent.com/render/math?math={\{t}_{e}"> : Extracted Token
*<img src="https://render.githubusercontent.com/render/math?math={\{t}_{g}"> : Ground-Truth Token
